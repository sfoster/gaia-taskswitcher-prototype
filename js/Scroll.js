(function() {
  ...
  function NativeScroll(el, initOptions) {
    ...
    var self = this,
        ...
        THRESHOLD_DISALLOW_SYSTEM_SWIPE = 5 * windowWidth / 100,
        // release system swipe (out of e.me)
        // only after finger had passed this value
        THRESHOLD_ALLOW_SYSTEM_SWIPE = 10 * windowWidth / 100;
  ...
  Object.defineProperty(Scroll.prototype, 'x', {
    get: function(x) {
      return this.element.scrollLeft;
    },
    set: function(x) {
      return this.element.scrollLeft = x;
    }
  });
  Object.defineProperty(Scroll.prototype, 'y', {
    ...
    set: function(y) {
      return this.element.scrollTop = x;
    }
  });
